% demo_batch_maxgirf_spiral_se_human_axial.m
...
L       = 8;   % rank of the SVD approximation of a higher-order encoding matrix

%% Define parameters
spiral_filename = 'meas_MID00275_FID03658_se_spiral_1102_ax_s24';
output_directory_filename = 'figures5&6';
user_opts.vds_factor   = 75;
user_opts.discard_pre  = 20;
user_opts.discard_post = 20;
support_constraint = 0;
channel_range = []; % a list of channel numbers that are used for recon
