% demo_non_cartesian_recon_human_sagittal.m
% Written by Nam Gyun Lee
% Email: namgyunl@usc.edu, ggang56@gmail.com (preferred)
% Started: 01/16/2022, Last modified: 01/31/2022
...
elseif strcmp(computer_type, 'GLNXA64')
    ismrmrd_noise_fullpath = '/scratch/nlee/NHLBI/data/20201102_NV_brain/noise/noise_meas_MID00260_FID03643_se_spiral_1102_sag_s24.h5';
    ismrmrd_data_fullpath  = '/scratch/nlee/NHLBI/data/20201102_NV_brain/h5/meas_MID00260_FID03643_se_spiral_1102_sag_s24.h5';
    siemens_dat_fullpath   = '/scratch/nlee/NHLBI/data/20201102_NV_brain/meas_MID00260_FID03643_se_spiral_1102_sag_s24.dat';
    B0map_fullpath         = '/server/home/nlee/lowfield_maxgirf/B0map_nlinv_min1.0e-06_sagittal_ro0.mat';
end
...
user_opts.support_constraint   = 1;
user_opts.selected_channels    = [(1:14).';16;17];
user_opts.N1                   = 640;              % reconstruction matrix size along the row direction
...
user_opts.L                    = 30;               % rank of the SVD approximation of a higher-order encoding matrix
