...
king_without_B0_correction_filename = sprintf('king_without_B0_correction_slice%d.mat', slice_nr);
...
load(fullfile(output_directory, king_without_B0_correction_filename));
...
im_king_without_B0_correction = reorient(im_king_without_B0_correction);
...
im3 = im_king_without_B0_correction / max(abs(im_king_without_B0_correction(:)));
...
caxis([0 cmax]);
colormap(gca, gray(256));
text(N2_zoom/2, 0, {'King''s method', 'without B0 correction'}, 'Color', color_order(3,:), 'FontSize', 14, 'Rotation', 0, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
...
caxis([0 cmax]);
colormap(gca, gray(256));
text(N2_zoom/2, 0, {'King''s method', 'with B0 correction'}, 'Color', color_order(3,:), 'FontSize', 14, 'Rotation', 0, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
...
export_fig('figure5', '-r400', '-tif', ...
   '-c[80,2520,470,1090]'); % [top,right,bottom,left]
