...
idx1_zoom_range = (200:265).';
idx2_zoom_range = (150:205).';
...
text(N2_zoom/2, -18, sprintf('Spiral SE, slice at %s = %4.1f mm', axis_text, slice_offset*1e3), 'Color', color_order(2,:), 'FontSize', 14, 'Rotation', 0, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
...
hold on;
annotation(gcf, 'arrow', [0.5614 0.5670]     , [0.7822 0.7982]      , 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]-0.07, [0.7822 0.7982]      , 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]-0.07, [0.7822 0.7982]-0.171, 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]     , [0.7822 0.7982]-0.171, 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);

annotation(gcf, 'arrow', [0.5614 0.5670]-0.025     , [0.7822 0.7982]-0.032      , 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]-0.025-0.07, [0.7822 0.7982]-0.032      , 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]-0.025-0.07, [0.7822 0.7982]-0.032-0.171, 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
annotation(gcf, 'arrow', [0.5614 0.5670]-0.025     , [0.7822 0.7982]-0.032-0.171, 'Color', 'r', 'HeadSize', 6, 'HeadStyle', 'plain', 'LineWidth', 2);
...
set(hc, 'FontSize', 10, 'Color', 'w', 'Position', [0.5887-0.002 0.1586+0.015 0.008 0.3014]);
title(hc, '[Hz]', 'Color', 'w');
...
export_fig('figure6', '-r400', '-tif', '-c[80,2520,470,1090]'); % [top,right,bottom,left]
