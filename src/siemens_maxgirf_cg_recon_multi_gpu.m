function [im_maxgirf_multislice, header, r_dcs_multislice, output] = siemens_maxgirf_cg_recon_multi_gpu(ismrmrd_noise_path, ismrmrd_data_path, siemens_dat_path, B0map, user_opts)
