function [im_cpr_multislice, header, r_dcs_multislice, output] = siemens_maxgirf_cp_recon_gpu(ismrmrd_noise_path, ismrmrd_data_path, siemens_dat_path, B0map, user_opts)
