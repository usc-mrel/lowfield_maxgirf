function [im_sense_multislice,header,r_dcs_multislice,output] = siemens_sense_recon(ismrmrd_noise_fullpath, ismrmrd_data_fullpath, siemens_dat_fullpath, user_opts)
...
for idx = 1:nr_recons
    ...
    %% Collect the output
    im_sense_multislice(:,:,idx) = im_sense;
