function [im_king, im_fs] = perform_deblurring_king_method_with_B0_correction(kspace, nufft_st, w, csm, gx, gy, gz, x, y, z, rotMatrixRCSToGCS, rotMatrixGCSToPCS, rotMatrixPCSToDCS, field_of_view_mm, DCS_offset, gamma, B0, dt, B0map)
...
if isempty(B0map)
    ...
    fc_XYZ = B0map;
    tc = repmat((0:Nk-1).' * dt, [1 Ni]); % Nk x Ni [sec]
end
